...
const resend = new resend_1.Resend('re_ML11Sbgc_Pp91NPMwdRKsATgpB6NGoNAU');
async function sendResetOtpEmail(to, otp) {
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to send OTP email');
    }
}
